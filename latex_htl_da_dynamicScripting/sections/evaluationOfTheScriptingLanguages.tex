...
Die Lua-Engine wird durch die Instanz state initialisiert. 
...
Durch die Verwendung von DoString in den Lua-Methoden wird Lua-Code direkt in der C\#-Anwendung ausgeführt.
