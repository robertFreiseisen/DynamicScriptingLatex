...
wodurch Zeit und Ressourcen gespart werden. Zudem profitieren Benutzer/innen von einer 
...
Diese Ressourcen erleichtern die Einarbeitung und ermöglichen es den Benutzer/innen, 
...
Darüber hinaus wäre es für die Softwareanbieter/innen schwierig, allen individuellen 
...
Entwicklungsressourcen, sowohl in Bezug auf die Anzahl der Entwickler/innen als auch die Zeit und 
...
die nur für eine kleine Anzahl von Nutzer/innen relevant sind, und damit den Wert der Software 
...
können Anpassungs- und Erweiterungsmöglichkeiten mit Hilfe von Scripting sein. 
Durch das Bereitstellen von Scripting-Schnittstellen wird den 
...
Updates und einer breiten Benutzerbasis, profitieren. Scripting stellt daher eine 
...
Interpreter ausgeführt, der den Code Zeile für Zeile umsetzt. Moderne Skriptsprachen wie 
...
für kleinere Aufgaben und schnelle Anpassungen macht. Scripting wird in einer Vielzahl von 
...
\begin{itemize}
    ...
    \item \textbf{Flexibilität:} Scripting ermöglicht es Benutzer/innen und Entwickler/innen, 
    die Funktionalität einer Anwendung nach Bedarf zu ändern, ohne die ursprüngliche 
    Software zu modifizieren.
    \item \textbf{Automatisierung:} Eines der Hauptanwendungsgebiete von Scripting ist 
    die Automatisierung wiederkehrender Aufgaben, wodurch Zeit und Ressourcen 
    gespart werden können.
    \item \textbf{Kostenersparnis:} Da Scripting meist schneller und mit weniger 
...
\begin{itemize}
    ...
    \item \textbf{Kompatibilitätsprobleme:} Nicht alle Skriptsprachen oder -Tools sind 
    mit allen Plattformen oder Anwendungen kompatibel. Manchmal sind spezielle 
    Anpassungen erforderlich.
    \item \textbf{Fehlermeldungen:} Fehlermeldungen durch Scripting können eine Herausforderung 
...
Dabei betrachten wir verschiedene Skriptsprachen und deren Integration in einer .NET-Anwendung.

\subsubsection*{Entwicklung einer Beispielanwendung}
Als praktischen Beleg für unsere Forschung haben wir eine Beispielanwendung entwickelt, in der wir 
...
\subsubsection*{Plugin Framework für .NET Core}

Das Plugin-Framework fungiert als Plattform für die Integration von Plugins in .NET Core-Anwendungen. 
Dabei werden verschiedene Technologien wie Blazor, WPF, Windows Forms und 
...
Programmierung einer Beispielanwendung, in der der Praxiseinsatz von verschiedenen 
...
\begin{itemize}
    \item Nutzer/innen können ein eigenes Skript, in der einen von uns unterstützten Skriptsprachen, 
    hochladen. Dieses dient dann als Basis für die individuelle Notenberechnung.
\end{itemize}
